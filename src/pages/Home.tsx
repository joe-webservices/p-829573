      ...
      <section className="py-16 px-6 md:px-12 bg-psyco-black-light">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
            <FeatureCard 
              icon={<Globe size={24} />}
              title="AI-Driven Facebook Ads"
              description="Our AI algorithms identify your ideal customers and optimize ad spend for maximum ROI, delivering qualified leads directly to your business."
            />
            
            <FeatureCard 
              icon={<Cpu size={24} />}
              title="Automated Lead Generation"
              description="We build customized workflows that qualify, nurture, and convert leads automatically through intelligent conversation systems."
            />
            
            <FeatureCard 
              icon={<Zap size={24} />}
              title="Performance-Based Model"
              description="No upfront payments. We operate on a performance basis - you only pay when we deliver results. Your success is our success."
            />
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            <ServiceCard 
              ...
              description="Engage with leads instantly through automated WhatsApp messaging systems that qualify and nurture prospects."
            />
            
            <ServiceCard 
              icon={<MessageSquare size={24} />}
              title="AI Chatbots"
              description="Intelligent conversation systems that engage website visitors 24/7, answering questions and qualifying leads."
            />
            
            <ServiceCard 
              icon={<Globe size={24} />}
              title="Facebook Ad Strategy"
              description="Data-driven approaches to targeting, creative development, and campaign optimization for maximum ROAS."
            />
            
            <ServiceCard 
              icon={<Cpu size={24} />}
              title="CRM Integration"
              description="Seamlessly connect your lead generation workflow with your existing CRM for streamlined operations."
            />
            
            <ServiceCard 
              icon={<BarChart3 size={24} />}
              title="Real-Time Reporting"
              description="Transparent dashboards showing campaign performance, lead quality, and conversion metrics in real-time."
            />
            
            <ServiceCard 
              icon={<Zap size={24} />}
              title="Conversion Optimization"
              description="Continuous improvement of your sales funnel through A/B testing and data-driven refinements."
            />
          </div>
        </div>
      </section>
